...
Description: Is a plugin that creates a integration between your WordPress blog and your Twitter account, including the BookMarklet.
Version: 2.0
...
<div class="inside">
<ul>
<li><img src="<?php bloginfo('wpurl') ?>/wp-content/plugins/wp-twitter/inc/logo.png" alt="" width="66" height="72" border="0" style="float:left; margin: 0px 5px 0px 0px; " /></li>
<li><p><?php global $wptwitter_version; ?>&nbsp;<strong><?php echo __( "Version:", "wp-twitter" ) . ' </strong>' . $wptwitter_version; ?></p></li>
<li><p> | <a href="http://webmais.com/wp-twitter" target="_blank">Plugin Homepage</a> |</p>
</li>
<br/><br/>
</ul>
</div>
