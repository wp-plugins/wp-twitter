...
add_action('admin_menu', 'wp_twitter_show_post_option');
...
function wp_twitter_show_post_option() {
	if ( function_exists( 'add_meta_box' ) ) {
		add_meta_box( 'wp_twitter-box', __( '(( WP Twitter ))', 'wp-twitter' ), 'wp_twitter_post_box', 'post', 'side' );
	}
	
}


function wp_twitter_post_box() {
global $post;
