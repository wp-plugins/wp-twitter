...
{
	echo "<div class=\"error\"><p>Please update your <a href=\"".get_bloginfo('wpurl')."/wp-admin/options-general.php?page=wp-twitter/wp-twitter.php\">Twitterbot username and password</a>.</p></div>";
}
...
function postToTwitter($username,$password,$message){
    ...
    //curl_setopt($ch, CURLOPT_POSTFIELDS, "source=wordpresstwitterbot");
