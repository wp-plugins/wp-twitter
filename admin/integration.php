...
<li><input name="wp_twitter_fdx_tweet_button_display_arquive" type="checkbox"<?php if(get_option('wp_twitter_fdx_tweet_button_display_arquive')!='-1') echo 'checked="checked"'; ?> value="1" /> <?php _e('Archive', 'fdx-lang') ?> <span class="description">  (<?php _e('category, tags, author, date, attachment', 'fdx-lang') ?>)</span> </li>
</ul>
</div></div>
...
<li><input name="wp_twitter_fdx_tweet_button_place" type="radio" value="after" <?php checked('after', $wp_twitter_fdx_tweet_button_place); ?> /> <?php _e('After Content', 'fdx-lang') ?> <span class="description">(<?php _e('default', 'fdx-lang') ?>)</span></li>
<li><input name="wp_twitter_fdx_tweet_button_place" type="radio" value="manual" <?php checked('manual', $wp_twitter_fdx_tweet_button_place); ?> /> <?php _e('Manual add', 'fdx-lang') ?>: <code><span style="color: #000000; font-weight: bold;">&lt;?php</span> <span style="color: #b1b100;">if</span><span style="color: #009900;">&#40;</span><span style="color: #990000;">function_exists</span><span style="color: #009900;">&#40;</span><span style="color: #0000ff;">'fdx_add_sharethis'</span><span style="color: #009900;">&#41;</span><span style="color: #009900;">&#41;</span> <span style="color: #009900;">&#123;</span> <span style="color: #0000ff;">fdx_add_sharethis&#40;&#41;</span><span style="color: #339933;">;</span><span style="color: #009900;">&#125;</span> <span style="color: #000000; font-weight: bold;">?&gt;</span></code></li>
</ul>
...
<!-- ******************************************tab1****************************************** -->
<p><strong><?php _e('Type of the Button', 'fdx-lang') ?>   </strong> </p>
...
<p><img src="<?php echo FDX1_PLUGIN_URL;?>/images/button_sidebar.png" width="232" height="100" border="0" alt="" style="vertical-align: middle"  /> <input name="wp_twitter_fdx_tweet_button_style2" type="radio" value="floatside_left" <?php checked('floatside_left', $wp_twitter_fdx_tweet_button_style2); ?> /> <?php _e('Left', 'fdx-lang') ?></p>
 </td>
 <td style="width: 50%; vertical-align: top">
<p><img src="<?php echo FDX1_PLUGIN_URL;?>/images/button_sidebar2.png" width="232" height="100" border="0" alt="" style="vertical-align: middle" /> <input name="wp_twitter_fdx_tweet_button_style2" type="radio" value="floatside_right" <?php checked('floatside_right', $wp_twitter_fdx_tweet_button_style2); ?> /> <?php _e('Right', 'fdx-lang') ?></p>
</td>
  </tr>
</table>
<!-- ******************************************tab2****************************************** -->
...
<!-- ******************************************tab3****************************************** -->
<p><strong><?php _e('Logo Area', 'fdx-lang') ?></strong> <span class="description"> (300x40 pix)</span>  </p>
...
<table style="width:100%;" class="widefat">
 <thead><tr><th><?php _e('Change order or modify list of buttons.', 'fdx-lang') ?></th> </tr></thead>
<tbody><tr class="alternate"><td>
<p><strong><?php _e('Selected Services', 'fdx-lang') ?>:</strong> <input name="wp_twitter_fdx_services" type="text" size="65" value="<?php echo get_option('wp_twitter_fdx_services'); ?>" /><small><em> (<?php _e('lowercase, separated by commas', 'fdx-lang') ?>)</em></small></p>
...
<div class="inside">
<p><input name="wp_twitter_fdx_tweet_button_choose" type="radio" value="multi_post" <?php checked('multi_post', $wp_twitter_fdx_tweet_button_choose); ?> /> <strong><?php _e('Multi Post', 'fdx-lang') ?></strong> <br /><span class="description"><?php _e('Sharing takes place inside the widget, without taking users away from your site. Preferences are saved so your users can share to more than one service at the same time.', 'fdx-lang') ?></span> </p>
<p><input name="wp_twitter_fdx_tweet_button_choose" type="radio" value="direct_post" <?php checked('direct_post', $wp_twitter_fdx_tweet_button_choose); ?> /> <strong><?php _e('Classic', 'fdx-lang') ?></strong> <br /> <span class="description"><?php _e('Your users will be redirected to Facebook, Twitter, etc when clicking on the corresponding buttons. The widget is opened when users click on "Email" and "ShareThis".', 'fdx-lang') ?></span></p>
 </div></div>

<!-- ***************************************************************************************** -->
<div class="postbox closed">
<div class="handlediv" title="<?php _e('Click to toggle', 'fdx-lang') ?>"><br /></div><h3 class='hndle'><span><?php _e('Want Analytics?', 'fdx-lang') ?></span></h3>
<div class="inside">


<p><a href="javascript:void(0);" onclick="PopupCenter('http://sharethis.com/external-login', 'page3_id1',562,342,'no');"><strong><?php _e('CLICK HERE TO REGISTER', 'fdx-lang') ?></strong></a> <span class="description">  <?php _e('At the end of the flow, you will be given a publisher key. Please paste it in the textbox below.', 'fdx-lang') ?> </span> </p>
<p><strong>Publisher key: </strong><input name="wp_twitter_fdx_tweet_button_twitter_username" type="text" size="45" value="<?php echo get_option('wp_twitter_fdx_tweet_button_twitter_username'); ?>" />&nbsp;&nbsp;&nbsp;&nbsp;<span id="butpop"><a href="javascript:void(0);" onclick="PopupCenter('http://sharethis.com/publishers/metrics-dashboard', 'page2_id2',980,680,'yes');"><code class="red"><?php _e('see their stats', 'fdx-lang') ?></code></a></span> </p>
<h3></h3>
<p><input name="wp_twitter_copynshare" type="checkbox"<?php if(get_option('wp_twitter_copynshare')!='-1') echo 'checked="checked"'; ?> value="1" /> <strong>CopyNShare (Beta)</strong> <br /><span class="description"> <?php _e('If activated, start tracking your users copy and paste shares by adding to your widget (Publisher key is required).', 'fdx-lang') ?> <strong><a href="http://support.sharethis.com/customer/portal/articles/517332#copynshare" target="_blank">FAQs</a></strong></span></p>
