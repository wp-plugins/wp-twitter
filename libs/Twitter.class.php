<?php
	...
	class Twitter {
		...
		function search($format='atom', $query) {
			$request = 'http://search.twitter.com/search.'.$format.'?q='.$query;
		...
		function show($format='xml',$id) {
			...
			$request = "https://api.twitter.com/1/users/show.$format?screen_name=".$id;
