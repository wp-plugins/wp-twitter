...
<p><a href="javascript:void(0);" onclick="PopupCenter('http://sharethis.com/external-login', 'page3_id1',562,342,'no');"><strong><?php _e('CLICK HERE TO REGISTER', $this->hook) ?></strong></a> <span class="description">  <?php _e('At the end of the flow, you will be given a publisher key. Please paste it in the textbox below.', $this->hook) ?> </span> </p>
